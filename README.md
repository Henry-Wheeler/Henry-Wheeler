...
CS + Math @ Santa Clara University. I like building things that sit at the intersection of computer vision, systems, and interactive software.
...
> Hardware + software system for real-time heart rate monitoring. Presented at NYU's Engineering for Good showcase.
...
Double major in Computer Science (Data Science) and Mathematics. Past work includes a research internship at the American Museum of Natural History (phylogenetic data pipelines) and a browser extension built at an Adobe hackathon.
